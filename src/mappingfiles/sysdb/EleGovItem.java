...
public class EleGovItem implements Serializable {
	...
	/** full constructor */
	public EleGovItem(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleGovItem(String CHR_ID, int SET_YEAR, String DISP_CODE,
