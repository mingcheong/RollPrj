...
public class EleBudgetCategory implements Serializable {
	...
	/** full constructor */
	public EleBudgetCategory(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetCategory() {
	}

	/** minimal constructor */
	public EleBudgetCategory(String CHR_ID, int SET_YEAR, String DISP_CODE,
