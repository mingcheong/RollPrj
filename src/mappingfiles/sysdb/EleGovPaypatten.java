...
public class EleGovPaypatten implements Serializable {
	...
	/** full constructor */
	public EleGovPaypatten(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleGovPaypatten() {
	}

	/** minimal constructor */
	public EleGovPaypatten(String CHR_ID, int SET_YEAR, String DISP_CODE,
