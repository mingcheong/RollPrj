...
public class EleBudgetOrigin implements Serializable {
	...
	/** full constructor */
	public EleBudgetOrigin(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetOrigin() {
	}

	/** minimal constructor */
	public EleBudgetOrigin(String CHR_ID, int SET_YEAR, String DISP_CODE,
