...
public class EleBudgetTarget implements Serializable {
	...
	/** full constructor */
	public EleBudgetTarget(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetTarget() {
	}

	/** minimal constructor */
	public EleBudgetTarget(String CHR_ID, int SET_YEAR, String DISP_CODE,
