...
public class EleFileNo implements Serializable {
	...
	/** full constructor */
	public EleFileNo(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			Integer FILE_YEAR, String FILE_DATE, String TITLE, String MEMO,
			String FILE_PRE, Integer FILE_NUM) {
		this.CHR_ID = CHR_ID;
	...
	/** minimal constructor */
	public EleFileNo(String CHR_ID, int SET_YEAR, String DISP_CODE,
