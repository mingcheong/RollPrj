...
public class EleBudgetItem implements Serializable {
	...
	/** full constructor */
	public EleBudgetItem(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetItem() {
	}

	/** minimal constructor */
	public EleBudgetItem(String CHR_ID, int SET_YEAR, String DISP_CODE,
