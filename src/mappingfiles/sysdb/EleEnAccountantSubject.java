...
public class EleEnAccountantSubject implements Serializable {
	...
	/** full constructor */
	public EleEnAccountantSubject(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String CHR_CODE5, String RG_CODE, Integer IS_DEBIT,
			Integer SUBJECT_TYPE, String SET_TYPE, String FE_CODE,
			String PARENT_ID, String CHR_ID1, String CHR_ID2, String CHR_ID3,
			String CHR_ID4, String CHR_ID5) {
		this.CHR_ID = CHR_ID;
	...
	/** default constructor */
	public EleEnAccountantSubject() {
	}

	/** minimal constructor */
	public EleEnAccountantSubject(String CHR_ID, int SET_YEAR,
			String DISP_CODE, String CHR_NAME, int LEVEL_NUM, int IS_LEAF,
			int ENABLED, String LATEST_OP_DATE, BigDecimal IS_DELETED,
			String SET_TYPE, String FE_CODE) {
		this.CHR_ID = CHR_ID;
		this.SET_YEAR = SET_YEAR;
		this.DISP_CODE = DISP_CODE;
		this.CHR_NAME = CHR_NAME;
	...
	public Integer getIS_DEBIT() {
		return this.IS_DEBIT;
	}

	public void setIS_DEBIT(Integer IS_DEBIT) {
		this.IS_DEBIT = IS_DEBIT;
	}
