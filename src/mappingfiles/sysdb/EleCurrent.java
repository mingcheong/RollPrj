...
public class EleCurrent implements Serializable {
	...
	/** full constructor */
	public EleCurrent(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleCurrent(String CHR_ID, int SET_YEAR, String DISP_CODE,
