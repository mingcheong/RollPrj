...
public class EleBudgetAdjust implements Serializable {
	...
	/** full constructor */
	public EleBudgetAdjust(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetAdjust() {
	}

	/** minimal constructor */
	public EleBudgetAdjust(String CHR_ID, int SET_YEAR, String DISP_CODE,
