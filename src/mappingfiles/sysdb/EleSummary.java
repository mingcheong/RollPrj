...
public class EleSummary implements Serializable {
	...
	/** full constructor */
	public EleSummary(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleSummary(String CHR_ID, int SET_YEAR, String DISP_CODE,
