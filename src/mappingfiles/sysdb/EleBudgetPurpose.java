...
public class EleBudgetPurpose implements Serializable {
	...
	/** full constructor */
	public EleBudgetPurpose(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetPurpose() {
	}

	/** minimal constructor */
	public EleBudgetPurpose(String CHR_ID, int SET_YEAR, String DISP_CODE,
