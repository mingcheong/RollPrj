...
public class ElePayAdjust implements Serializable {
	...
	/** full constructor */
	public ElePayAdjust(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public ElePayAdjust(String CHR_ID, int SET_YEAR, String DISP_CODE,
