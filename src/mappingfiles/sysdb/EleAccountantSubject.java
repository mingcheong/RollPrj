...
public class EleAccountantSubject implements Serializable {
	...
	/** full constructor */
	public EleAccountantSubject(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			Integer SUBJECT_TYPE, String SET_TYPE, String PARENT_ID,
			String CHR_ID1, String CHR_ID2, String CHR_ID3, String CHR_ID4,
			String CHR_ID5, String ST_CODE) {
		this.CHR_ID = CHR_ID;
	...
	/** default constructor */
	public EleAccountantSubject() {
	}

	/** minimal constructor */
	public EleAccountantSubject(String CHR_ID, int SET_YEAR, String DISP_CODE,
