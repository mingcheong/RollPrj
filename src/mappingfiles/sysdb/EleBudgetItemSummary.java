...
public class EleBudgetItemSummary implements Serializable {
	...
	/** full constructor */
	public EleBudgetItemSummary(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String CHR_CODE5, String RG_CODE, String OWNER_CODE,
	...
	/** default constructor */
	public EleBudgetItemSummary() {
	}

	/** minimal constructor */
	public EleBudgetItemSummary(String CHR_ID, int SET_YEAR, String DISP_CODE,
