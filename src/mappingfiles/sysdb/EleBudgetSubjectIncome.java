...
public class EleBudgetSubjectIncome implements Serializable {
	...
	/** full constructor */
	public EleBudgetSubjectIncome(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetSubjectIncome() {
	}

	/** minimal constructor */
	public EleBudgetSubjectIncome(String CHR_ID, int SET_YEAR,
			String DISP_CODE, String CHR_NAME, int LEVEL_NUM, int IS_LEAF,
