...
public class EleBookSet implements Serializable {
	...
	/** full constructor */
	public EleBookSet(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String CHR_CODE5, String RG_CODE, String START_DATE, int SET_TYPE,
