...
public class EleIncomeItem implements Serializable {
	...
	/** full constructor */
	public EleIncomeItem(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleIncomeItem() {
	}

	/** minimal constructor */
	public EleIncomeItem(String CHR_ID, int SET_YEAR, String DISP_CODE,
