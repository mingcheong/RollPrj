...
public class ElePayFillMode implements Serializable {
	...
	/** full constructor */
	public ElePayFillMode(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public ElePayFillMode() {
	}

	/** minimal constructor */
	public ElePayFillMode(String CHR_ID, int SET_YEAR, String DISP_CODE,
