...
public class ElePaySummary implements Serializable {
	...
	/** full constructor */
	public ElePaySummary(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public ElePaySummary() {
	}

	/** minimal constructor */
	public ElePaySummary(String CHR_ID, int SET_YEAR, String DISP_CODE,
