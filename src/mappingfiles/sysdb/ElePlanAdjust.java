...
public class ElePlanAdjust implements Serializable {
	...
	/** full constructor */
	public ElePlanAdjust(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public ElePlanAdjust() {
	}

	/** minimal constructor */
	public ElePlanAdjust(String CHR_ID, int SET_YEAR, String DISP_CODE,
