...
public class ElePayMode implements Serializable {
	...
	/** full constructor */
	public ElePayMode(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public ElePayMode(String CHR_ID, int SET_YEAR, String DISP_CODE,
