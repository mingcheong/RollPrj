...
public class EleControltype implements Serializable {
	...
	/** full constructor */
	public EleControltype(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleControltype() {
	}

	/** minimal constructor */
	public EleControltype(String CHR_ID, int SET_YEAR, String DISP_CODE,
