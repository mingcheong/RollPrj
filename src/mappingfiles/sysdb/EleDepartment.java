...
public class EleDepartment implements Serializable {
	...
	/** full constructor */
	public EleDepartment(String CHR_ID, int SET_YEAR, String CHR_CODE,
			String DISP_CODE, String DISP_NAME, int LEVEL_NUM, int IS_LEAF,
	...
	/** default constructor */
	public EleDepartment() {
	}

	/** minimal constructor */
	public EleDepartment(String CHR_ID, int SET_YEAR, String DISP_CODE,
			String DISP_NAME, int LEVEL_NUM, int IS_LEAF, int ENABLED,
			String LATEST_OP_DATE, BigDecimal IS_DELETED) {
		this.CHR_ID = CHR_ID;
		this.SET_YEAR = SET_YEAR;
		this.DISP_CODE = DISP_CODE;
