...
public class ElePayBillType implements Serializable {
	...
	/** full constructor */
	public ElePayBillType(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public ElePayBillType() {
	}

	/** minimal constructor */
	public ElePayBillType(String CHR_ID, int SET_YEAR, String DISP_CODE,
