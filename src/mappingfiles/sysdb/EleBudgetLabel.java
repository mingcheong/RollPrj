...
public class EleBudgetLabel implements Serializable {
	...
	/** full constructor */
	public EleBudgetLabel(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetLabel() {
	}

	/** minimal constructor */
	public EleBudgetLabel(String CHR_ID, int SET_YEAR, String DISP_CODE,
