...
public class EleIncomepaymanage implements Serializable {
	...
	/** full constructor */
	public EleIncomepaymanage(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleIncomepaymanage() {
	}

	/** minimal constructor */
	public EleIncomepaymanage(String CHR_ID, int SET_YEAR, String DISP_CODE,
