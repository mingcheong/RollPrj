...
public class EleRegion implements Serializable {
	...
	/** full constructor */
	public EleRegion(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleRegion(String CHR_ID, int SET_YEAR, String DISP_CODE,
