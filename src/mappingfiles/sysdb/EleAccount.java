...
public class EleAccount implements Serializable {
	...
	/** full constructor */
	public EleAccount(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String ACCOUNT_NAME, String BANK_CODE, int ACCOUNT_TYPE,
			String OWNER_CODE, String PARENT_ID, String CHR_ID1,
	...
	/** minimal constructor */
	public EleAccount(String CHR_ID, int SET_YEAR, String DISP_CODE,
			String CHR_NAME, int LEVEL_NUM, int IS_LEAF, int ENABLED,
			String LATEST_OP_DATE, BigDecimal IS_DELETED, String RG_CODE,
			String ACCOUNT_NO, String BANK_CODE, int ACCOUNT_TYPE) {
		this.CHR_ID = CHR_ID;
		this.SET_YEAR = SET_YEAR;
		this.DISP_CODE = DISP_CODE;
		this.CHR_NAME = CHR_NAME;
