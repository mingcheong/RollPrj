...
public class EleForeignMoney implements Serializable {
	...
	/** full constructor */
	public EleForeignMoney(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String CHR_CODE5, String PARENT_ID, String RG_CODE, String CHR_ID1,
	...
	/** default constructor */
	public EleForeignMoney() {
	}

	/** minimal constructor */
	public EleForeignMoney(String CHR_ID, int SET_YEAR, String DISP_CODE,
