...
public class EleBudgetSummary implements Serializable {
	...
	/** full constructor */
	public EleBudgetSummary(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetSummary() {
	}

	/** minimal constructor */
	public EleBudgetSummary(String CHR_ID, int SET_YEAR, String DISP_CODE,
