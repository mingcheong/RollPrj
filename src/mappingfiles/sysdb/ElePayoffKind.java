...
public class ElePayoffKind implements Serializable {
	...
	/** full constructor */
	public ElePayoffKind(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public ElePayoffKind() {
	}

	/** minimal constructor */
	public ElePayoffKind(String CHR_ID, int SET_YEAR, String DISP_CODE,
