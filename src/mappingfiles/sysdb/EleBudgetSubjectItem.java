...
public class EleBudgetSubjectItem implements Serializable {
	...
	/** full constructor */
	public EleBudgetSubjectItem(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetSubjectItem() {
	}

	/** minimal constructor */
	public EleBudgetSubjectItem(String CHR_ID, int SET_YEAR, String DISP_CODE,
