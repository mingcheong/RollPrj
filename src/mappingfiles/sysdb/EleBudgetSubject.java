...
public class EleBudgetSubject implements Serializable {
	...
	/** full constructor */
	public EleBudgetSubject(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetSubject() {
	}

	/** minimal constructor */
	public EleBudgetSubject(String CHR_ID, int SET_YEAR, String DISP_CODE,
