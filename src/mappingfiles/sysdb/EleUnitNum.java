...
public class EleUnitNum implements Serializable {
	...
	/** full constructor */
	public EleUnitNum(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleUnitNum(String CHR_ID, int SET_YEAR, String DISP_CODE,
