...
public class EleManageBranch implements Serializable {
	...
	/** full constructor */
	public EleManageBranch(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleManageBranch() {
	}

	/** minimal constructor */
	public EleManageBranch(String CHR_ID, int SET_YEAR, String DISP_CODE,
