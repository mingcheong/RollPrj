...
public class ElePayeeAccount implements Serializable {
	...
	/** full constructor */
	public ElePayeeAccount(String CHR_ID, int SET_YEAR, String CHR_CODE,
			...
			String CHR_CODE5, String RG_CODE, String ACCOUNT_NO,
			String ACCOUNT_NAME, String PAYEE_NAME, String BANK_CODE,
			String BANK_NAME, int ACCOUNT_TYPE, String OWNER_CODE,
	...
	/** default constructor */
	public ElePayeeAccount() {
	}

	/** minimal constructor */
	public ElePayeeAccount(String CHR_ID, int SET_YEAR, String DISP_CODE,
			String CHR_NAME, int LEVEL_NUM, int IS_LEAF, int ENABLED,
			String LATEST_OP_DATE, BigDecimal IS_DELETED, String RG_CODE,
			String ACCOUNT_NO, String BANK_NAME, int ACCOUNT_TYPE) {
		this.CHR_ID = CHR_ID;
		this.SET_YEAR = SET_YEAR;
		this.DISP_CODE = DISP_CODE;
		this.CHR_NAME = CHR_NAME;
