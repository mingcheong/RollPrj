...
public class EleBudgetKind implements Serializable {
	...
	/** full constructor */
	public EleBudgetKind(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** default constructor */
	public EleBudgetKind() {
	}

	/** minimal constructor */
	public EleBudgetKind(String CHR_ID, int SET_YEAR, String DISP_CODE,
