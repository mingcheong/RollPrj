...
public class EleEditor implements Serializable {
	...
	/** full constructor */
	public EleEditor(String CHR_ID, int SET_YEAR, String CHR_CODE,
	...
	/** minimal constructor */
	public EleEditor(String CHR_ID, int SET_YEAR, String DISP_CODE,
