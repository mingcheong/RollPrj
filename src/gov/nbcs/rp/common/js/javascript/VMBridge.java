...
public abstract class VMBridge
{
    ...
    private static VMBridge makeInstance()
    {
        for (int i = 0; i != 3; ++i) {
            String className;
            if (i == 0) {
                className = "gov.nbcs.rp.common.js.javascript.VMBridge_custom";
            } else if (i == 1) {
                className = "gov.nbcs.rp.common.js.javascript.jdk13.VMBridge_jdk13";
            } else {
                className = "gov.nbcs.rp.common.js.javascript.jdk11.VMBridge_jdk11";
            }
