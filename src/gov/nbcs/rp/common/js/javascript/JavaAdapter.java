...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lgov/nbcs/rp/common/js/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lgov/nbcs/rp/common/js/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lgov/nbcs/rp/common/js/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName)
    {
        cfw.startMethod("<init>",
                        "(Lgov/nbcs/rp/common/js/javascript/ContextFactory;"
                        +"Lgov/nbcs/rp/common/js/javascript/Scriptable;)V",
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "gov/nbcs/rp/common/js/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "gov/nbcs/rp/common/js/javascript/JavaAdapter",
                      "runScript",
                      "(Lgov/nbcs/rp/common/js/javascript/Script;"
                      +")Lgov/nbcs/rp/common/js/javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "gov/nbcs/rp/common/js/javascript/Context",
                                       ...
                                       Class returnType)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Lgov/nbcs/rp/common/js/javascript/Function;");
