...
package gov.nbcs.rp.common.js.javascript.optimizer;

import gov.nbcs.rp.common.js.javascript.CompilerEnvirons;
import gov.nbcs.rp.common.js.javascript.Context;
import gov.nbcs.rp.common.js.javascript.Function;
import gov.nbcs.rp.common.js.javascript.FunctionNode;
import gov.nbcs.rp.common.js.javascript.GeneratedClassLoader;
import gov.nbcs.rp.common.js.javascript.Interpreter;
import gov.nbcs.rp.common.js.javascript.Kit;
import gov.nbcs.rp.common.js.javascript.NativeFunction;
import gov.nbcs.rp.common.js.javascript.Node;
import gov.nbcs.rp.common.js.javascript.ObjArray;
import gov.nbcs.rp.common.js.javascript.ObjToIntMap;
import gov.nbcs.rp.common.js.javascript.Script;
import gov.nbcs.rp.common.js.javascript.ScriptOrFnNode;
import gov.nbcs.rp.common.js.javascript.Scriptable;
import gov.nbcs.rp.common.js.javascript.SecurityController;
import gov.nbcs.rp.common.js.javascript.Token;
...
public class Codegen extends Interpreter
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "gov.nbcs.rp.common.js.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            ...
            cfw.addInterface("gov/nbcs/rp/common/js/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "gov/nbcs/rp/common/js/javascript/BaseFunction",
                      "createObject",
                      "(Lgov/nbcs/rp/common/js/javascript/Context;"
                      +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                      +")Lgov/nbcs/rp/common/js/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "gov/nbcs/rp/common/js/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "gov/nbcs/rp/common/js/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "gov/nbcs/rp/common/js/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lgov/nbcs/rp/common/js/javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "gov/nbcs/rp/common/js/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lgov/nbcs/rp/common/js/javascript/Callable;"
                      +"Lgov/nbcs/rp/common/js/javascript/Context;"
                      +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                      +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lgov/nbcs/rp/common/js/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "gov/nbcs/rp/common/js/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lgov/nbcs/rp/common/js/javascript/Context;"
                      +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "gov/nbcs/rp/common/js/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lgov/nbcs/rp/common/js/javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lgov/nbcs/rp/common/js/javascript/Context;"
                      +")Lgov/nbcs/rp/common/js/javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "gov/nbcs/rp/common/js/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "gov/nbcs/rp/common/js/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lgov/nbcs/rp/common/js/javascript/Context;"
                  +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                  +"Lgov/nbcs/rp/common/js/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lgov/nbcs/rp/common/js/javascript/Scriptable;"
          +"Lgov/nbcs/rp/common/js/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generatePrologue()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "gov/nbcs/rp/common/js/javascript/Scriptable",
                          "getParentScope",
                          "()Lgov/nbcs/rp/common/js/javascript/Scriptable;");
        ...
        if (fnCurrent != null) {
            ...
            addScriptRuntimeInvoke("createFunctionActivation",
                                   "(Lgov/nbcs/rp/common/js/javascript/NativeFunction;"
                                   +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                                   +"[Ljava/lang/Object;"
                                   +")Lgov/nbcs/rp/common/js/javascript/Scriptable;");
            cfw.addAStore(variableObjectLocal);
        ...
        if (compilerEnv.isGenerateDebugInfo()) {
            cfw.addVariableDescriptor(debugVariableName, "Lgov/nbcs/rp/common/js/javascript/Scriptable;", cfw.getCurrentCodeOffset(), variableObjectLocal);
        }
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lgov/nbcs/rp/common/js/javascript/Context;)V");
    }
        ...
        switch (type) {
              ...
              case Token.THROW:
                ...
                cfw.add(ByteCode.NEW,
                        "gov/nbcs/rp/common/js/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lgov/nbcs/rp/common/js/javascript/Context;"
                    +")Lgov/nbcs/rp/common/js/javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lgov/nbcs/rp/common/js/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                            +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lgov/nbcs/rp/common/js/javascript/Callable;"
                            +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                            +"Lgov/nbcs/rp/common/js/javascript/Context;"
                            +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "gov/nbcs/rp/common/js/javascript/Callable",
                "call",
                "(Lgov/nbcs/rp/common/js/javascript/Context;"
                +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                +"Lgov/nbcs/rp/common/js/javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "gov/nbcs/rp/common/js/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "gov/nbcs/rp/common/js/javascript/EvaluatorException";
        } else {
            if (exceptionType != ECMAERROR_EXCEPTION) {
				Kit.codeBug();
			}
            exceptionName = "gov/nbcs/rp/common/js/javascript/EcmaError";
        }
