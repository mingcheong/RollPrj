...
public class TableSorter extends AbstractTableModel {
	...
	public void addNotSort(int column) {
		if (this.notSort == null) {
			notSort = new HashSet();
		}
		notSort.add(new Integer(column));
	}
	...
	public void setTableHeader(JTableHeader tableHeader) {
		...
		if (this.tableHeader != null) {
			...
			this.tableHeader.setDefaultRenderer(new SortableHeaderRenderer(
					(MyHeaderRenderer) this.tableHeader.getDefaultRenderer()));
		}
	}
	...
	private class MouseHandler extends MouseAdapter {
		public void mouseClicked(MouseEvent e) {
			if (allowOrder) {
				...
				if ((column != -1) && !notSort.contains(new Integer(column))) {
	...
	private class SortableHeaderRenderer extends MyHeaderRenderer {
		private MyHeaderRenderer tableCellRenderer;

		public SortableHeaderRenderer(MyHeaderRenderer tableCellRenderer) {
			this.tableCellRenderer = tableCellRenderer;
		}

		public String getCheckLabel() {
			return tableCellRenderer.getCheckLabel();
		}

		public void setCheckLabel(String checkLabel) {
			tableCellRenderer.setCheckLabel(checkLabel);
		}

		public void setChecked(boolean checked) {
			tableCellRenderer.setChecked(checked);
		}

		public boolean isChecked() {
			return tableCellRenderer.isChecked();
		}
