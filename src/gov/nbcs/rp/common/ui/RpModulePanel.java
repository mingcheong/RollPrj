...
/**
 * The class RpModulePanel. 预算编审风格的UI基类 <br>
 * 1、实现了doClose()方法 <br>
 * 2、占位实现ActionedUIEx接口中其他方法，子类根据需要覆盖。
 */
public abstract class RpModulePanel extends FModulePanel implements ActionedUIEx
{

	/**
	 * Instantiates a new fb module panel.
	 */
	public RpModulePanel()
	{
		super();
	}
