 ...
 * @author 谢昀荪
 *
 * @version 创建时间：Jul 11, 20122:53:54 PM
 *
 * @Description
 */
	public class PrjSearch extends RpModulePanel {
		/**
		 * 
		 */
		...
		private FPanel getRPanel() {
			...
			this.btnE.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					try {
						PrjSearch.this.setTableProp();
						PrjSearch.this.fxmbm.setValue("");
						PrjSearch.this.fxmmc.setValue("");
						PrjSearch.this.fzxzq.setValue("001");

						PrjSearch.this.fqsnd.setValue("");
						PrjSearch.this.fjsnd.setValue("");
						PrjSearch.this.fxmfl.setValue("");
						PrjSearch.this.fxmsx.setValue("");
						PrjSearch.this.fxmzt.setValue("");
						PrjSearch.this.fkmxz.setValue("");
					} catch (Exception ee) {
			...
			try {
				...
				String[] columnText =
				{ "项目名称","预计预算总投入", "历年投入", "当年预算投入", "年中追加","合计",
					"资金缺口","当年支出", "支出进度" };

				String[] columnField = {"xmmc", "sb_111", "sb_222", "sb_333", "f11_alls",
						"total_money", "lack_money", "pay_monty","pay_plan" };
				...
				this.table.getTable().addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						if ((e.getButton() != 2) && (e.getButton() != 3)) {
							try {
								if (PrjSearch.this.dsAll
										.gotoBookmark(PrjSearch.this.table
												.rowToBookmark(PrjSearch.this.table
														.getTable()
														.getSelectedRow()))) {
									PrjSearch.this.fxmbm
											.setValue(PrjSearch.this.dsAll
													.fieldByName("xmbm")
													.getString());

									PrjSearch.this.fxmmc
											.setValue(PrjSearch.this.dsAll
													.fieldByName("xmmc")
													.getString());

									PrjSearch.this.fqsnd
											.setValue(PrjSearch.this.dsAll
													.fieldByName("qsnd")
													.getString());

									PrjSearch.this.fjsnd
											.setValue(PrjSearch.this.dsAll
													.fieldByName("jsnd")
													.getString());

									PrjSearch.this.fzxzq
											.setValue(PrjSearch.this.dsAll
													.fieldByName("zxzq")
													.getString());

									PrjSearch.this.fxmfl
											.setValue(PrjSearch.this.dsAll
													.fieldByName("xmfl")
													.getString());

									PrjSearch.this.fxmsx
											.setValue(PrjSearch.this.dsAll
													.fieldByName("xmsx")
													.getString());

									PrjSearch.this.fxmzt
											.setValue(PrjSearch.this.dsAll
													.fieldByName("xmzt")
													.getString());

									String xmxh = PrjSearch.this.dsAll
											.fieldByName("xmxh").getString();

									PrjSearch.this.fkmxz.setText(QrBudgetAction
		...
		public void doAdd() {
			try {
				...
				this.dsAll = QrBudgetAction.getMethod().find_alllife(
