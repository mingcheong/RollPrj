...
public class QrBudgetUI extends RpModulePanel {
	/**
	 * 
	 */
	...
	private FPanel getRPanel() {
		...
		this.btnE.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					QrBudgetUI.this.setTableProp();
					QrBudgetUI.this.fxmbm.setValue("");
					QrBudgetUI.this.fxmmc.setValue("");
					QrBudgetUI.this.fzxzq.setValue("001");

					QrBudgetUI.this.fqsnd.setValue("");
					QrBudgetUI.this.fjsnd.setValue("");
					QrBudgetUI.this.fxmfl.setValue("");
					QrBudgetUI.this.fxmsx.setValue("");
					QrBudgetUI.this.fxmzt.setValue("");
					QrBudgetUI.this.fkmxz.setValue("");
				} catch (Exception ee) {
			...
			this.table.getTable().addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					if ((e.getButton() != 2) && (e.getButton() != 3)) {
						try {
							if (QrBudgetUI.this.dsAll
									.gotoBookmark(QrBudgetUI.this.table
											.rowToBookmark(QrBudgetUI.this.table
													.getTable()
													.getSelectedRow()))) {
								QrBudgetUI.this.fxmbm
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("xmbm")
												.getString());

								QrBudgetUI.this.fxmmc
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("xmmc")
												.getString());

								QrBudgetUI.this.fqsnd
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("qsnd")
												.getString());

								QrBudgetUI.this.fjsnd
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("jsnd")
												.getString());

								QrBudgetUI.this.fzxzq
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("zxzq")
												.getString());

								QrBudgetUI.this.fxmfl
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("xmfl")
												.getString());

								QrBudgetUI.this.fxmsx
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("xmsx")
												.getString());

								QrBudgetUI.this.fxmzt
										.setValue(QrBudgetUI.this.dsAll
												.fieldByName("xmzt")
												.getString());

								String xmxh = QrBudgetUI.this.dsAll
										.fieldByName("xmxh").getString();

								QrBudgetUI.this.fkmxz.setText(QrBudgetAction
